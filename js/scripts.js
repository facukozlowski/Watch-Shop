				...
				<div class="detalles-content">
					...
					<p class="description">
						<b>Descripcion: </b> <span> Lorem ipsum dolor sit amet consectetur adipisicing elit.
							Reprehenderit officia rerum et. Dignissimos adipisci dolore, pariatur velit repellat fugiat
							molestiae corrupti explicabo aliquid esse hic obcaecati vero, tenetur, provident
							delectus!</span>
					</p>
					<p class="description">
						<span>
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Error vitae ea magnam
							exercitationem minus eum delectus, dolor nihil doloremque eligendi laborum ratione eaque
							dolorem nam vel quis soluta ducimus ut.
						</span>
					</p>
    ...
    renderProductos(productos) {
        ...
        productos.forEach((producto) => {
            ...
            <div class="bottom">
              <div class="btn__group">
                <button class="btn addToCart" data-id=${producto.id}>Añadir al carrito</button>
                <a href="producto-detalles.html?id=${producto.id}" class="btn view">Ver</a>
              </div>
            </div>
          </div>
            `
